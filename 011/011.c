...
int data[20][20] = { { 8,  2, 22, 97, 38, 15,  0, 40,  0, 75,
...
int main(void){
   ...
   for (i = 0; i < 20; i++){
      for(j = 0; j < 20; j++){
         if(data[i][j] * data[i][(j+1)%20] * data[i][(j+2)%20] * data[i][(j+3)%20] > max){
            max = data[i][j] * data[i][(j+1)%20] * data[i][(j+2)%20] * data[i][(j+3)%20];
         }
      }
   }
   /* max by column */
   for (i = 0; i < 20; i++){
      for(j = 0; j < 20; j++){
         if(data[i][j] * data[(i+1)%20][j] * data[(i+2)%20][j] * data[(i+3)%20][j] > max){
            max = data[i][j] * data[(i+1)%20][j] * data[(i+2)%20][j] * data[(i+3)%20][j];
         }
      }
   }
//   /* max by l-r diagonal */
   for(i = 0; i < 20; i++){
      for(j = 0; j < 20; j++){
         if(data[i][j] * data[(i+1)%20][(j+1)%20] * data[(i+2)%20][(j+2)%20] * data[(i+3)%20][(j+3)%20] > max){
            max = data[i][j] * data[(i+1)%20][(j+1)%20] * data[(i+2)%20][(j+2)%20] * data[(i+3)%20][(j+3)%20];
         }
      }
   }
   ...
   for(i = 0; i < 20; i++){
      for(j = 10; j < 30; j++){
         if(data[i][j%20] * data[(i+1)%20][(j-1)%20] * data[(i+2)%20][(j-2)%20] * data[(i+3)%20][(j-3)%20] > max){
            max = data[i][j%20] * data[(i+1)%20][(j-1)%20] * data[(i+2)%20][(j-2)%20] * data[(i+3)%20][(j-3)%20];
         }
      }
   }

   printf("PE-011 Answer = %d\n", max);
   return 0;
